    ...
    <FormSection @submitted="updateProfileInformation">
        ...
        <template #form>
            ...
            <div v-if="$page.props.jetstream.managesProfilePhotos" class="tw-col-span-6 sm:tw-col-span-4">
                ...
                <div v-show="photoPreview" class="tw-mt-2">
                    <span
                        class="tw-block tw-rounded-full tw-w-20 tw-h-20 tw-bg-cover tw-bg-no-repeat tw-bg-center"
                        :style="'background-image: url(\'' + photoPreview + '\');'"
                    />
                </div>

                <SecondaryButton class="tw-mt-2 tw-me-2" type="button" @click.prevent="selectNewPhoto">
                    Select A New Photo
                </SecondaryButton>
                ...
                <InputError :message="form.errors.photo" class="tw-mt-2" />
            </div>
            ...
            <div class="tw-col-span-6 sm:tw-col-span-4">
                ...
                <div v-if="$page.props.jetstream.hasEmailVerification && user.email_verified_at === null">
                    <p class="tw-text-sm tw-mt-2 dark:tw-text-white">
                    ...
                    <div v-show="verificationLinkSent" class="tw-mt-2 tw-font-medium tw-text-sm tw-text-green-600 dark:tw-text-green-400">
        ...
        <template #actions>
            <ActionMessage :on="form.recentlySuccessful" class="tw-me-3">
                Saved.
            </ActionMessage>
